/**
 * TypeScript-deklarationsfil för Electron API
 * 
 * Definierar typerna för alla API som exponeras från huvudprocessen till renderingsprocessen
 * via contextBridge.
 */
